...
<center>
<h2 class = "inset">Profile update request</h2><hr>

<div class = "formr">

<form method = "post" action = "profileeditintotable.jsp" name = "login_form">
...
<input type = "text" placeholder = "Enter correct value" name = "value" required><br><br>
<p>Anything to say?</p>
