...
<div id="mySidenav" class="sidenav">
  ...
  <div class="dropdown">
  <a class="dropbtn">Edit Request</a>
  <div class="dropdown-content"> 
    <a href="profileedit.jsp">Profile</a>
    <a href="achedit.jsp">Achievement</a>
  </div>
</div>
...
%>
<marquee behavior="scroll" direction="left" style="background-color:white">Achievements are now open to upload till <%=rs2.getDate("todate")%>!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div id="main"></div>
<ol class="articles">
  <li class="articles__article" style="--animation-order:1"><a href="seminar.jsp?sid=<%=std%>" class="articles__link">
