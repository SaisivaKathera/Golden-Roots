    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            <p class="mb-0"><strong class="pr-1">Faculty ID:</strong><%=rs.getInt("fid")%></p>
            <p class="mb-0"><strong class="pr-1">Qualification: </strong><%=rs.getString("qual")%></p>
      ...
      <div class="col-lg-8">
        <div class="card shadow-sm">
          ...
          <div class="card-body pt-0">
            ...
            <form class = "form-container" method = "post" action = "deletefaculty.jsp?did=<%=rs.getInt("fid")%>">
              <input type = "submit" value="Delete Faculty" class = "btn">
