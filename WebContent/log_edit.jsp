...
ResultSet rs = s.executeQuery("select * from upload_check");
Statement s1 = con.createStatement();
ResultSet rs1 = s1.executeQuery("select * from verification_check");
rs.next();
rs1.next();
...
<body bgcolor = "grey" >
<a class="btn" href="log_book.jsp"><i class="fa fa-home"></i></a>
...
<center><h2 class = "inset">Student Uploads Deadlines Update</h2></center><hr>
<br><br><br>
<center>
<form method = "post" action="log_s_edit.jsp">

<input type = "date" value="<%= rs.getDate("todate")%>" name="utdate"  required>
<input type = "submit" value="Update Deadlines" required>
...
<center><h2 class = "inset">Faculty Verification Deadlines Update</h2></center><hr>
<br><br><br>

<center>
<form method="post" action="log_f_edit.jsp">

<input type = "date" value ="<%= rs1.getDate("todate")%>" name="utdate"  required>
<input type = "submit" value ="Update Deadlines" required>
