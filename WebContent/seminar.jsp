...
ResultSet rs116 = s116.executeQuery("select * from upload_check where uid = 1");
rs116.next();
...
<a href="studentstatus.jsp" style="color:white"><i class='fas fa-info-circle'></i> </a>
<br><br>
<center>


<%
if(rs116.getString("uploads").equals("true")){
