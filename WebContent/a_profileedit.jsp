...
ResultSet rs = s.executeQuery("select * from editsprofile");
...
String a = "accepted";
ResultSet rs2 = s2.executeQuery("select count(*) from editsprofile where progress = '"+a+"'");
if(rs2.next()){
p1 = rs2.getInt(1);
}
...
a = "declined";
ResultSet rs3 = s3.executeQuery("select count(*) from editsprofile where progress = '"+a+"'");
if(rs3.next()){
p2 = rs3.getInt(1);
}
...
a = "In Progress";
ResultSet rs4 = s4.executeQuery("select count(*) from editsprofile where  progress = '"+a+"'");
if(rs4.next()){
p3 = rs4.getInt(1);
}
...
<br>
<center><h2 class = "inset">Profile Requests</h2></center><hr>
<%-- <center>
<div class = "formr">
...
if(n != 0 && p3 != 0){
	...
	while(rs.next())
		...
		System.out.println(rs.getInt("epid"));
	...
	<td><%=rs.getString("cvalue") %></td>
	<td><%=rs.getString("reason") %></td>
	<td><a style="color:black" href="a_profile_edit.jsp?std=<%=rss.getInt("sid")%>&epid=<%=rs.getInt("epid")%>"><i class="fa fa-eye"></i></a></td>
