...
String a = "accepted";
ResultSet rs2 = s2.executeQuery("select count(*) from seminar where status = '"+a+"'");
if(rs2.next()){
p1 = rs2.getInt(1);
}
Statement s3 = con.createStatement();
a = "declined";
ResultSet rs3 = s3.executeQuery("select count(*) from seminar where status = '"+a+"'");
if(rs3.next()){
p2 = rs3.getInt(1);
}
Statement s4 = con.createStatement();
a = "In Progress";
ResultSet rs4 = s4.executeQuery("select count(*) from seminar where  status = '"+a+"'");
if(rs4.next()){
p3 = rs4.getInt(1);
}
