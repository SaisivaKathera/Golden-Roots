...
<input type = "text" placeholder = "Student Id" name = "sid" required><br><br>
<input type = "text" placeholder = "Student Name" name = "sname" required><br><br>
<select id="gender" name="gender">
    <option value="Male">Male</option>
    <option value="Female">Female</option>
  </select><br><br>
<input type = "text" placeholder = "Student Email" name = "mail" required><br><br>
...
<!-- <input type = "text" placeholder = "Student Program" name = "prgm" required><br><br> -->
<input type = "text" placeholder = "Student year as yxx" name = "year" required><br><br>
<input type = "text" placeholder = "Student Sem" name = "sem" required><br><br>
<input type = "text" placeholder = "Student Mobile" name = "mobile" required><br><br>
