...
ResultSet rs1 = s1.executeQuery("select * from uploads_log ");
rs1.last();
Statement s = con.createStatement();
s.executeUpdate("update upload_check set todate ='"+utdate+"' ");
Statement s3 = con.createStatement();
s3.executeUpdate("update uploads_log set tdate ='"+utdate+"' where ulid = "+rs1.getInt("ulid")+"");
